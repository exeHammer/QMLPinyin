...
class AtomDictBase {
 public:
   ...
   */
  virtual int number_of_lemmas() = 0;
   ...
   */
  virtual int get_lpis(const uint16 *splid_str, uint16 splid_str_len,
                          LmaPsbItem *lpi_items, int lpi_max) = 0;
   ...
   */
  virtual int predict(const char16 last_hzs[], uint16 hzs_len,
   ...
   */
  virtual int get_total_lemma_count() = 0;
   ...
   */
  virtual void set_total_lemma_count_of_others(int count) = 0;
