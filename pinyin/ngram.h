...
static const int kCodeBookSize = 256;
...
class NGram {
 public:
  ...
  static const int kSysDictTotalFreq = 100000000;
 ...
 public:
  ...
  void set_total_freq_none_sys(int freq_none_sys);
  ...
  bool build_unigram(LemmaEntry *lemma_arr, int num,
